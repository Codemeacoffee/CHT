...
use CHT\Http\Controllers\Auth\ValidateController;
use CHT\Image;
use CHT\News;
    ...
    function dragDrop(Request $request){
        ...
        if($admin){
            ...
            if ($file != null) {
                ...
                if (!([ 'file' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048'])) {
    ...
    function editCourse(Request $request)
    {
        ...
        if ($admin) {
            ...
            if (!$course ) {
                ...
                }if(strlen(htmlspecialchars($request->input('end_date'))) != 0){
                    $course->end_date = htmlspecialchars($request->input('end_date'));
        ...
        if ($admin) {
            ...
            if(strlen(htmlspecialchars($request->input('hours')))>0){
                Course::create([
                    ...
                    'hours' => htmlspecialchars($request->input('hours')),
                    'img_code' => $random
                ]);
            }else{
                Course::create([
