...
<head>
    <title>CHT - Panel de Control</title>
...
<div id="outerNavBar" style="top: 0; z-index: 10001;">
    <a class="adminHeader" href="{{URL::to('admin')}}"><img style=" margin: 1rem auto 1rem auto; display: block;" src="{{asset('images/CHT-logo.svg')}}"/></a>
</div>
<div class="leftHalf">
        ...
        <div id="courses">
            ...
            <div class="filterBar">
                <div class='containerEdit'>
                    <span>Nombre</span>
                    <input onkeyup="filterCourses(($('#courseFilterName').val()),($('#filterLevel').val()),($('#courseFilterSector').val()))" id="courseFilterName" type="text">
                </div>
                <div class='containerEdit'>
                    <span>Sector</span>
                    <input spellcheck="false" onfocusout="($(this).parent().find('div:first')).html('')" onfocusin="ajaxFilterSector($(this).val(), $(this), ($(this).parent().find('div:first')))" onchange="filterCourses(($('#courseFilterName').val()),($('#filterLevel').val()), ($('#courseFilterSector').val()));" onkeyup="filterCourses(($('#courseFilterName').val()),($('#filterLevel').val()),($('#filterLocation').val()),($('#courseFilterSector').val()));ajaxFilterSector($(this).val(), $(this), ($(this).parent().find('div:first')))" id="courseFilterSector" type="text">
                    <div id="ajaxContainer"></div>
                </div>
                <div class="containerEdit">
                    <span>Nivel</span>
                    <select onchange="filterCourses(($('#courseFilterName').val()),($('#filterLevel').val()), ($('#courseFilterSector').val()))" id="filterLevel">
                        <option name=""></option>
            ...
            foreach ($courses as $course){
                ...
                $now = new DateTime();
                $date->modify('+1 day');
                if($date<$now && $course['public'] != '1' && $course['public'] != '2' && $course['display'] != '2'){
