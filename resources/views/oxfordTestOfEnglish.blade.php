...
<div id="oxfordTestOfEnglish" class="fichaDiv" Style="margin-bottom: 3rem;">
    ...
    <p>Ahora con <strong>Centro de Hostelería y Turismo de Canarias</strong> obtén la certificación oficial de la <a href="https://www.oxfordtestofenglish.es/" target="_blank">
    ...
    <p>Puedes realizar una&nbsp;<a style="text-decoration: underline;color: #15284c;" href="https://www.oxfordtestofenglish.es/prueba-el-examen-2/">DEMO</a>&nbsp;de cada una de las partes del Oxford Test of English para saber a qué te enfrentarás a la hora de realizar el examen.</p>
    ...
    <p><button class="oxfordButton" onclick="oxfordInscription('Oxford Test of English (4 competencias)', '{{URL::to('oxfordInscription')}}')">Inscríbete</button></p>
    ...
    <p><button class="oxfordButton" onclick="oxfordInscription('Oxford Test of English (1 competencia)', '{{URL::to('oxfordInscription')}}')">Inscríbete</button></p>
</div>
